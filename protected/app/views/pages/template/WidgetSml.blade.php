...
@foreach ($projectList as $project)
   <div id="widget">        
        ...
        <div class="meter_div">
          <div class="small_price1" style="margin-top:0px;margin-left:15px;font-family:'PT Sans Narrow'">
          <a target="_blank" href="../show-project/{{ $project->project_alias }}" target="_blank">
            {{$project->title}}
          </a>
        </div>
          ...
          <div>
              <span class="small_price1" style="font-family:'PT Sans Narrow'">Rp {{ number_format($project->hitung_f,0,",",".") }} donated</span>
               @if( $project->days_to_go->format("%r%a") <= 0) 
                   @if( $project->status == 2) 
                    <span class="small_price2" style="font-family:'PT Sans Narrow'">Successful !</span>
                  @elseif ($project->status == 3)
                    <span class="small_price2" style="font-family:'PT Sans Narrow'">Unsuccessful !</span>
                  @else
                    <span class="small_price2" style="font-family:'PT Sans Narrow'">0 days left</span>
                  @endif
                @else
                <span class="small_price2" style="font-family:'PT Sans Narrow'">{{ $project->days_to_go->format("%r%a") }} days left</span>
              @endif
            </div>

        </div>
      <div class="button_link_root" style="margin-top:0px;margin-right:10px">
        <div class="project-logo" style="margin-top:5px;">{{ HTML::image('sximo/images/logo1_project.png') }}</div>
        <div class="button_link_div" style="margin-left:45px;margin-top:5px;">
            <a class="button_link button_view" style="color:white" href="../show-project/{{ $project->project_alias }}" target="_blank">Open</a>
        </div>  
      </div>
    </div>
