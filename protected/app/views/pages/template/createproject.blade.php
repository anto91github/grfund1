 ...
 <!--
    <div class="row" style="margin-left:25px;">
        ...
        <div class="col-md-4" style="margin-bottom:10px">
            <span style="font-size:30px; color:green;" class="fa fa-check-square-o"></span>
            <span>&nbsp;{{ Lang::get('core.home_check1') }}</span>
        </div>
        <div class="col-md-4" style="margin-bottom:10px">
            <span style="font-size:30px; color:red;" class="fa fa-bullseye"></span>
            <span>{{ Lang::get('core.home_target1') }}</span>
        </div>
        <div class="col-md-2">
        </div>
    </div>
    ...
    <div class="row" style="margin-left:25px;">
        ...
        <div class="col-md-4" style="margin-bottom:10px">
            <span style="font-size:30px; color:green;" class="fa fa-check-square-o"></span>
            <span>&nbsp;{{ Lang::get('core.home_check2') }}</span>
        </div>
        <div class="col-md-4" style="margin-bottom:10px">
            <span style="font-size:30px; color:red;" class="fa fa-bullseye"></span>
            <span>{{ Lang::get('core.home_target2') }}</span>
        </div>
        <div class="col-md-2">
        </div>
    </div>
    ...
    <div class="row" style="margin-left:25px;">
        ...
        <div class="col-md-4">
            <span style="font-size:30px; color:green;" class="fa fa-check-square-o"></span>
            <span>&nbsp;{{ Lang::get('core.home_check3') }}</span>
        </div>
        <div class="col-md-4">
            <span style="font-size:30px; color:red;" class="fa fa-bullseye"></span>
            <span>{{ Lang::get('core.home_target3') }}</span>
        </div>
        <div class="col-md-2">
        </div>
    </div>
-->
    <div class="row" style="margin-left:25px;">
        <img src="images/create-step.jpg" width='100%' height="450px">
     </div>
            ...
            <div class="form-horizontal" style="margin-top:20px; padding:0px 5px 0px 5px;">
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-8'>
                        ...
                        <span class="help-block">Minimum Rp. 10.000.000 <span style="float:right;font-size:16px"><a href="Refference#funding" style="color:blue;">{{Lang::get('core.incentive');}}</a></span> </span>
                    </div>
                </div>
                <div class="form-group">
