        ...
        <div class="row" style="padding-left: 30px; padding-right: 30px;">
                    ...
                    <div class="row" style="border:1px solid #E8E8E8; padding:10px; margin-bottom:5px; margin-top:5px; background-color: #E8E8E8;">
                        ...
                        ?>
                                ...
                                <div id="content" style="display:none">
                                    ...
                                    <p style="font-size:16px;"><b>To:</b> {{ $d->name }}</p>
            ...
            <div class="col-md-4">
                <div style="border:1px solid #E8E8E8;  min-height:260px; overflow:hidden; margin-bottom: 10px; background-color: #FFFFFF;">
                        <div style="padding:10px;">
                            ...
                            <div style="text-align: center;"><h4 style="font-size: 16px;"><small>project finished at {{ $project->due_date }}</small></h4></div>
                             @if( $project->days_to_go->format("%r%a") > 0)
                            <div class="text-center"><a href="../show-project/{{$project->project_alias}}?step=1" class="btn btn-primary">Fund this project</a></div>
                             @endif                           
                        </div>
                </div>
                ...
                <div class="col-md-12 container-reward" style="margin-bottom:10px;">
                    ...
                    @if($project->days_to_go->format("%r%a") > 0)
                        @if($c > 0)
                            <div style="width:100%; float:left; margin-top:5px;" align="center" ><a href="../show-project/{{$project->project_alias}}?step=1&pledge={{ $reward->reward_id }}&amount={{ $reward->reward_minimum }}" class="btn btn-primary" style="width: 200px; border-radius:10px !important;">Fund Rp. {{ number_format($reward->reward_minimum,0,",",".") }} or more</a></div>
                        @else
