...
<div>
  ...
  <div class="homepageHero">
      ...
      <div class="homepageHero-subtitle">
        <div id="content">   
          <a class="video"  title="Tutorial 'How To Make Video Pitch'" href="https://www.youtube.com/watch?v=RDR02AzqUBA&amp;autoplay=1">1{{ HTML::image('images/YouTube-icon-full_color.png', 'video', array('class'=>'vid_head')) }}</a>    
        </div>
      </div>      
    </div>    
</div>
                                                ...
                                                <div style="padding-left:10px; padding-right:10px;">
                                                  ...
                                                  @if($charity->category == 3 || $charity->category == 10 )
                                                    <div style="padding-top:10px; text-align:center; padding-bottom:5px;" >
                                                        <a class="project-title" href="show-project/{{ $charity->project_alias }}" title="{{$charity->title_lang}}">{{ str_limit($charity->title_lang, $limit = 26, $end = '...') }}</a>
                                                    </div>
                                                  @else
                                                    <div style="padding-top:11px; text-align:center; padding-bottom:5px;" >
                                                        <a class="project-title" href="show-project/{{ $charity->project_alias }}" title="{{$charity->title_lang}}">{{ substr($charity->title_lang,0,27).(strlen($charity->title_lang) > 26 ? "...": "")  }} {{-- str_limit($charity->title_lang, $limit = 26, $end = '***') --}}</a>
                                                    </div>
                                                  @endif
