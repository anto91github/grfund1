            ...
            <div class="tab-pane fade {{ $tab == 1  ? "active" : "" }} in" id="tabGeneral">
                ...
                <div id="container-general" style='border:1px solid #5d5d5d; box-shadow: 6px 6px 5px #888888; height:auto;'>
                    ...
                    <div class="form-horizontal" style="margin-top:20px; padding:0px 5px 0px 5px;">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Recipient <span class="required color-red">*</span></label>
                            <div class='col-md-8'>
                                <input type="text" name="recipientName" id="recipientName" class="form-control" placeholder="Enter recipient name" value="{{ $project->recipient }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                <div class="col-md-offset-3 col-md-8">
                                    <button type="submit" class="btn btn-primary">Save</button> <a href="account" class="btn btn-default" >Cancel</a>
                                </div>
                        </div>
                    </div>
                    <br/>
    ...
    <div class="col-md-4" id='containerPreview'>
        <div style='border:1px solid #E8E8E8;  min-height:400px; overflow:hidden; box-shadow:5px 5px 5px #888888;' id="previewproject">
            ...
            <div style="padding-left:10px; padding-right:10px;">
                ...
                <div style="padding-bottom:10px;" id="previewContent" >{{ $project->small_content }}</div>
                ...
                <div style="text-align: center;"><h4>Rp <span id="previewProjectFund">0</span><br/><small>of Rp <span id="previewProjectAmount">0</span></small></h4></div>
...
<script type='text/javascript'>
    ...
    $(window).load(function(){
        ...
        redrawDonutGraph({{ $project->fund_amount }},1);
        ...
        $("#mask_currency").on("change",function(){
            ...
            redrawDonutGraph({{ $project->fund_amount }},amount);
        });
        ...
        function updateReview(){
            ...
            amount = amount.replace(/\_/g,"");
            $("#previewProjectAmount").html(formatNumber(amount, ".", ",")); 
            $("#previewProjectFund").html(formatNumber({{ $project->fund_amount }}, ".", ",")); 
            redrawDonutGraph({{ $project->fund_amount }},amount);
        }
        updateReview();
