                ...
                <div class="tab-pane fade active in" id="tabContent">
                    ...
                    <div id="container-start" class="col-md-12" style='border:1px solid #5d5d5d; box-shadow: 6px 6px 5px #888888; height:auto; padding:0px;'>
                        ...
                        <div>
                            ...
                            <div class="form-horizontal" style="margin-top:20px; padding:0px 10px 0px 10px; background-color:#fff;">
                                <div class="form-group">
                                    <div class="col-xs-12 col-md-12"><h5 style="font-family: 'Helvetica'; font-weight:700;">2222 Issue statement:</h5> <p>Highlight the key issue to grab the public's interest and attention</p>
                                    </div>
...
<script type='text/javascript'>
    ...
    $(window).load(function(){        
        ...
        var amount = "50000";//"{{-- $value_p[0]['amount'] --}}";
        var endDate = "2015-06-30";//"{{-- $value_p[0]['due_date'] --}}";
