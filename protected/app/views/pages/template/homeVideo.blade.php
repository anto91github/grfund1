<style>
			...
			.video-logo
			{
				/*text-align:center;
				padding-top:0px; 
				background: url('video/home-vid/logo.png') center no-repeat; 
				height:165px;
				background-color: red;*/

				width: 100%;
			    height: 165px;
			    background-image: url('video/home-vid/logo.png');
			...
			@media (max-width: 580px) {
				...
				body 
				{
			        //background: url(img/header_new7.jpg) no-repeat;

			        width: 100%;
				    height: 470px;
				    background-image: url('img/ss_vid1.jpg');
				    background-repeat: no-repeat;
				    background-size: cover;
		...
		<div class="grf-menu" align="center">
			<div class="col-md-6" style="padding-top:0px;">
				<a href="charity">				
					<!--<img src="video/home-vid/charity.png">-->
					<img src="video/home-vid/charity.png" class="img-responsive" onmouseover="hover_charity(this);" onmouseout="unhover_charity(this);" align="center">				
				</a>
			</div>

			<div class="col-md-6" style="padding-top:0px;">
				<a href="UnderConstruction"><!--<a href="startup">-->
					<!--<img src="video/home-vid/business.png">-->
					<img src="video/home-vid/business.png" class="img-responsive" onmouseover="hover_business(this);" onmouseout="unhover_business(this);" align="center">				
     ...
     <!--<div class="row margin-bottom-40 our-clients" style="padding-left:60px; padding-right:10px;">
      ...
      <div class="col-sm-12 col-md-12 client">
        <div class="owl-carousel owl-carousel6-brands">
         @foreach($label as $label_slider)   
          <div class="client-item" style="height:128px;">
              <a href="showHome/{{$label_slider->alias}}" target="_blank">
                  <img src="video/home-vid/{{$label_slider->image}}" class="img-responsive" height="130" onmouseover="hover_{{$label_slider->alias}}(this);" onmouseout="unhover_{{$label_slider->alias}}(this);">
              </a>            
          </div>          
          @endforeach        
...
function hover_charity(element) {
      element.setAttribute('src', 'video/home-vid/charity-hover.png');
  }
function unhover_charity(element) {
      element.setAttribute('src', 'video/home-vid/charity.png');
  }

 function hover_business(element) {
      element.setAttribute('src', 'video/home-vid/business-hover.png');
  }
  function unhover_business(element) {
      element.setAttribute('src', 'video/home-vid/business.png');
  }
