    ...
    <div class="row" style="text-align:center; margin-top:0px;">
      <div class="col-md-3">
          <div class="area-header col-xs-12 col-sm-12 col-md-12" >
            <h2 style="font-size:30px;">Staff <span>Pick</span> {{ date('F') }}</h2>
          </div>
            ...
            <div style=" overflow:hidden; border-top-right-radius: 4px; border-top-left-radius: 4px; text-alignment:center;">
                                                ...
                                                <div style="padding-left:10px; padding-right:10px;">
                                                    <div style="padding-top:10px; text-align:center; padding-bottom:5px;" >
                                                        <a class="project-title" href="show-project/{{ $staffpick[0]->project_alias }}" title="{{$staffpick[0]->title}}">{{ substr($staffpick[0]->title,0,21) }}</a>
                                                    </div>
                                                    <div style="padding-bottom:0px; height:50px; font-family: 'PT Sans Narrow'; color:#898989;" >{{ $staffpick[0]->small_content }}</div>
      ...
      <div class="col-md-6">
        <div class="col-md-12">          
          <a href="./create-project" style="padding:0px;border:0px;margin-right:-3px;">{{ HTML::image('images/a.png', 'Find Project', array('style'=>'padding:0px;margin:0px;')) }}</a>
          {{ HTML::image('images/b.png', 'Find Project', array('style'=>'padding:0px;margin:0px;border:0px;margin-right:0px;')) }}
          <a href="./projects" style="padding:0px;margin-left:-3px;">{{ HTML::image('images/c.png', 'Find Project', array('style'=>'padding:0px;margin:0px;')) }}</a>
        </div>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6" style="text-align:left; font-size:16px; color:#696969; margin-bottom:20px; margin-top:20px; ">
              <table border="0">
                <tr>
                  ...
                  <td style="padding-left:5px;">Organizations or Small-Medium Enterprises may apply</td>
                </tr>
              </table>
            </div>
            <div class="col-md-6" style="text-align:right; font-size:16px; color:#696969; margin-bottom:20px; margin-top:20px; ">Minimum target 10 Juta &nbsp;&nbsp;<span style="font-size:30px; color:red; float:right;" class="fa fa-bullseye"></span></div>
          </div>
          <div class="row">
            <div class="col-md-6" style="text-align:left; font-size:16px; color:#696969; margin-bottom:20px;">
              <table border="0">
                <tr>
                  <td><span style="font-size:30px; color:green; float:left;" class="fa fa-check-square-o"></span></td>
                  <td style="padding-left:5px;">Projects can be located in any province across Indonesia</td>
                </tr>
              </table>
            </div>
            <div class="col-md-6" style="text-align:right; font-size:16px; color:#696969; margin-bottom:20px; ">Fundraising 30 - 180 Days &nbsp;&nbsp;<span style="font-size:30px; color:red; float:right;" class="fa fa-bullseye"></span></div>
          </div>
          <div class="row">
            <div class="col-md-6" style="text-align:left; font-size:16px; color:#696969; margin-bottom:20px;">
              <table border="0">
                <tr>
                  <td><span style="font-size:30px; color:green; float:left;" class="fa fa-check-square-o"></span></td>
                  <td style="padding-left:5px;">Indonesian Banks & International Credit Cards Accepted</td>
                </tr>
              </table>
            </div>
            <div class="col-md-6" style="text-align:right; font-size:16px; color:#696969; margin-bottom:20px; ">Choose within our 12 Categories &nbsp;&nbsp;<span style="font-size:30px; color:red; float:right;" class="fa fa-bullseye"></span></div>
          </div>
        </div>
        
        <div class="col-md-12" style="padding-top:20px;">
          Read our <a href="#">Frequently Ask Question (FAQ)</a> and <a href="#">Terms & Conditions</a> for more information
        </div>
      </div>
      <div class="col-md-3">
          <div class="area-header col-xs-12 col-sm-12 col-md-12" >
            <h2 style="font-size:30px;">Newest <span>Project</span></h2>
          </div>
          <div class="col-md-12" style="padding-left:15px;padding-right:15px; padding-bottom:5px;">
          <div style="border:1px solid #E8E8E8;  min-height:300px; overflow:hidden; background-color:#fff;  ">
            <div style=" overflow:hidden; border-top-right-radius: 4px; border-top-left-radius: 4px; text-alignment:center;">
                                                ...
                                                <div style="padding-left:10px; padding-right:10px;">
                                                    <div style="padding-top:10px; text-align:center; padding-bottom:5px;" >
                                                        <a class="project-title" href="show-project/{{ $newest[0]->project_alias }}" title="{{$newest[0]->title}}">{{ substr($newest[0]->title,0,21) }}</a>
                                                    </div>
                                                    <div style="padding-bottom:0px; height:50px; font-family: 'PT Sans Narrow'; color:#898989;" >{{ $newest[0]->small_content }}</div>
				...
				<div class="col-sm-6 col-md-3" style="padding-left:15px;padding-right:15px; padding-bottom:5px;">
					<div style="border:1px solid #E8E8E8;  min-height:400px; overflow:hidden; background-color:#fff;  ">
						<div style=" overflow:hidden; border-top-right-radius: 4px; border-top-left-radius: 4px; text-alignment:center;">
                                                ...
                                                <div style="padding-left:10px; padding-right:10px;">
                                                    <div style="padding-top:10px; text-align:center; padding-bottom:5px;" >
                                                        <a class="project-title" href="show-project/{{ $charity->project_alias }}" title="{{$charity->title}}">{{ substr($charity->title,0,21) }}</a>
                                                    </div>
                                                    <div style="padding-bottom:0px; height:50px; font-family: 'PT Sans Narrow'; color:#898989;" >{{ $charity->small_content }}</div>
                                                    ...
                                                    @if( $charity->days_to_go->format("%r%a") <= 0)
                                                        @if( $charity->status == 2)                                                    
                                                            <div style="text-align: center;"><h4 style="font-size: 16px; color:#fff; background-color: #1db262; padding-top:5px; padding-bottom:5px">Successful !</h4></div>
                                                        @elseif ($charity->status == 3)  
                                                            <div style="text-align: center;"><h4 style="font-size: 16px; color:#fff; background-color: #e54a1a; padding-top:5px; padding-bottom:5px">Unsuccessful !</h4></div>
                                                        @else
                                                            <div style="text-align: center;"><h4 style="font-size: 16px; padding-top:5px; padding-bottom:5px;">0<small> days left</small></h4></div>
                                                        @endif                                                  
                                                    @else
                                                        <div style="text-align: center;"><h4 style="font-size: 16px; padding-top:5px; padding-bottom:5px">{{ $charity->days_to_go->format("%r%a") }}<small> {{ Lang::get('core.home_days_left') }}</small></h4></div>
                                                    @endif
                                                </div>
					</div>
            ...
            <a href="#">
              <table border="0" width="100%">
                <tr>
                  ...
                  <td>
                    <div>
                        <span style="font-size:23px;">Community</span><br/>
                        <p>Social unit of any size that shares common values</p>
                    </div>
                  </td>
                </tr>
              </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
              <tr>
                ...
                <td>
                  <div>
                      <span style="font-size:23px;">Art & Creative</span><br/>
                      <p>Creation of painting, sculpture, and other visual media</p>
                  </div>
                </td>
              </tr>
            </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Health & Disabilities</span><br/>
                    <p>State of complete physical, mental and social well-being</p>
                </div>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Education</span><br/>
                    <p>Process of facilitating learning</p>
                </div>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 " align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Business / Startup</span><br/>
                    <p>Organization involved in the trade of goods, services</p>
                </div>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
              <tr>
                ...
                <td>
                  <div>
                      <span style="font-size:23px;">Charity</span><br/>
                      <p>Practice of being benevolent, giving and sharing</p>
                  </div>
                </td>
              </tr>
            </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Emergency</span><br/>
                    <p>Situation that poses an immediate risk to health or life</p>
                </div>
              </td>
            </tr>
          </table>
          ...
          <a href="#">
            <table border="0" width="100%">
              <tr>
                ...
                <td>
                  <div>
                      <span style="font-size:23px;">Event</span><br/>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Sport</span><br/>
                    <p>All forms of usually competitive physical activity</p>
                </div>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 " align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Environment & Conservation</span><br/>
                    <p>Surroundings which a person, animal, or plant lives</p>
                </div>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 " align="center">
          ...
          <table border="0" width="100%">
            <tr>
              ...
              <td>
                <div>
                    <span style="font-size:23px;">Family</span><br/>
                    <p>Family purpose</p>
                </div>
              </td>
            </tr>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12" align="center">
          ...
          <table border="0" width="100%">
              <tr>
                ...
                <td>
                  <div>
                      <span style="font-size:23px;">Technology</span><br/>
                      <p>Application of scientific and knowledge</p>
                  </div>
                </td>
              </tr>
            </table>
...
<div class="container">
  <div class="row" style="color:#999; background-color:#fff; padding:5px 15px 5px 15px;">
        <div class="area-header col-md-12" >
            <h2 style="font-size:30px;">SOCIAL <span>STREAM</span></h2>
            <h4>Latest gotong royong updates</h4>
        </div>
    </div>
  <div class="row">
    ...
    <div class="col-md-3">
            <!--<iframe src="http://snapwidget.com/sc/?u=Z290b25ncm95b25nZnVuZHxpbnwxNTB8M3wzfHx5ZXN8MjB8bm9uZXx8eWVzfG5v&ve=170615" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:300px; height:150px"></iframe>-->
...
<div class="container">
    <div class="row" style="color:#999; background-color:#fff; padding:5px 15px 5px 15px;">
        <div class="area-header col-md-6 col-sm-6 col-xs-12" >
            <h2 style="font-size:30px;">BENEFICIARY <span>TESTIMONIAL</span></h2>
            <h4>Latest gotong royong updates</h4>
        </div>
        <div class="area-header col-md-6 col-sm-6 col-xs-12" >
            <h2 style="font-size:30px;">TEAM <span>TESTIMONIAL</span></h2>
            <h4>Latest gotong royong updates</h4>
        </div>
    </div>
    <div class="row" style="padding:5px;">
        <div class="col-md-6 col-sm-6 col-xs-12 testimonial">
          ...
          <!--
            ...
            <div class="tab-content" style="padding:10px; border-left:1px solid #E8E8E8; border-right:1px solid #E8E8E8; border-bottom:1px solid #E8E8E8; min-height: 140px;">
            ...
            <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="active item">
                  ...
                  <div class="carousel-info" style="padding-left:20px;">
                    <img class="pull-left" src="uploads/users/1.jpg" alt="" style="border-radius: 50%; overflow:hidden; width:50px;">
                    <div class="pull-left" style="padding-left:20px;">
                      <span class="testimonials-name">Lina Mars</span><br/>
                ...
                <div class="item">
                  ...
                  <div class="carousel-info">
                    <img class="pull-left" src="uploads/users/1.jpg" alt="">
                    <div class="pull-left">
...
<div class="container">
    ...
    <div class="row margin-bottom-40 our-clients" style="padding-left:10px; padding-right:10px;">
      <div class="area-header col-sm-3 col-md-3">
        <h2 style="font-size:20px;"><a href="#">{{ Lang::get('core.home_our_client') }}</a></h2>
...
<div class="container">
    ...
    <div class="row margin-bottom-40 our-clients" style="padding-left:10px; padding-right:10px;">
      <div class="area-header col-sm-3 col-md-3">
        <h2 style="font-size:20px;"><a href="#">PAYMENTS <span>ACCEPTED</span></a></h2>
        <p>Lorem dipsum folor margade sitede lametep eiusmod psumquis dolore.</p>
      </div>
      <div class="col-sm-9 col-md-9 client">
        {{ HTML::image('images/bank-logo.png','bank-logo',array('width'=>'100%'))}}
      </div>          
    </div>
    <!-- END CLIENTS -->
</div>
