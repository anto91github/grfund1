...
<div class="container">
        <div class="row" style="padding-left: 30px; padding-right: 30px;">
            ...
            <ul class="nav nav-pills">
                <li class="active" style="width:183px;font-size:18px;text-align:center; background-color:#dadac8;">
                        <a href="#tabHome" data-toggle="tab">
                        Home </a>
                </li>
                <li style="width:183px;font-size:18px;text-align:center; background-color:#dadac8;">
            ...
            <div class="tab-content col-md-8" style="padding-left:0px; padding-right:0px;">
                <div class="tab-pane fade active in" id="tabHome" style="border:1px solid #D8D8D8; background-color: #FFFFFF; padding-top:10px; padding-bottom:10px; padding-left:20px; padding-right:20px; ">
                    ...
                    <div style="font-size:24px">{{$date}}</div>
                    <div style="font-size:20px;padding-bottom:10px">{{$post_header}}</div>
                    
                    <br/>
                    {{html_entity_decode($post_content)}}
                ...
                <div class="tab-pane fade in" id="tabBacker" style="padding-left:20px; padding-right:20px;">
                    ...
                    <div class="row" style="border:1px solid #E8E8E8; padding:10px; margin-bottom:5px; margin-top:5px; background-color: #E8E8E8;">
                        ...
                        <div class="col-md-8"><span style="font-size:16px;">Rp. {{ number_format($backer->backer_amount,0,",",".") }} - {{ $backer->reward_title_lang }}</span></div>
                    </div>
                    @endforeach
                    @else
                    <div class="row" style="border:1px solid #E8E8E8; padding:10px; margin-bottom:5px; margin-top:5px; background-color: #E8E8E8;">
                ...
                <div class="tab-pane fade in" id="tabUpdate" style="padding-left:20px; padding-right:20px;">
