    ...
    <div class="row" style="text-align:center; margin-top:0px;">
      ...
      <div class="col-md-6">
        <div class="col-md-12">
            ...
            <div class="col-md-10" style="background-image: url('images/button-start-clean.png');background-position: center; background-repeat: no-repeat;height:83px;width:437px; margin-left: auto; margin-right: auto;">
                <a href="./create-project"><span style="float:left;position:absolute;right:218px;width:218px;height:83px;text-decoration: none;"></span></a>
                <a href="./projects"><span style="float:right;position:absolute;top:0px;width:218px;height:83px;text-decoration:none;"></span></a>
             </div>            
            <span class="col-md-1">
              &nbsp;  
            </span>          
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6" style="margin-left:160px;margin-right:50px; width:380px">
       <div id="fb-root" style="width:380px">
...
<div class="container">
    <div class="row" style="color:#999; background-color:#fff; padding:5px 15px 5px 15px;">
        <div class="area-header col-md-6 col-sm-6 col-xs-12" >
            ...
            <h4>{{ Lang::get('core.home_bene_d') }}</h4>
        </div>
        <div class="area-header col-md-6 col-sm-6 col-xs-12" >
...
<div class="container">
    ...
    <div class="row margin-bottom-40 our-clients" style="padding-left:10px; padding-right:10px;">
      <div class="area-header col-sm-3 col-md-3">
        <h2 style="font-size:20px;"><a href="#">{{ Lang::get('core.home_payment') }}</a></h2>
        <p>{{ Lang::get('core.home_payment_d') }}</p>
      </div>
      <div class="col-sm-9 col-md-9 client">
