  ...
  <div class="container">
    <div class="row">      
      ...
      <div class="area-header col-xs-12 col-sm-8 col-md-8">
        <span class="component" style="margin-top: 10px;">       
            <!-- Start Nav Structure -->
            <button class="cn-button" id="cn-button">Menu</button>
            <div class="cn-wrapper" id="cn-wrapper">
              <ul>
                <li title="Staff Pick"><a href="show-project/{{ $staffpick[0]->project_alias }}"><span class="fa fa-hand-o-right" style="font-size:1em; margin-top:-10px"></span></a></li>
                <li title="Newest Project"><a href="show-project/{{ $newest[0]->project_alias }}"><span class="fa fa-star-o" style="font-size:1em; margin-top:-10px"></span></a></li>
                <li title="Start"><a href="./create-project"><span class="fa fa-pencil-square-o" style="font-size:1em; margin-top:-10px"></span></a></li>
                <li title="Browse"><a href="./projects"><div class="fa fa-folder-open-o" style="font-size:1em; margin-top:35px"></div></a></li>
                <li title="Social Stream"><a href="./SosialStream"><span class="fa fa-users" style="font-size:1em; margin-top:-10px"></span></a></li>
                <li title="Testimonial"><a href="./Testimoni"><span class="fa fa-file-text-o" style="font-size:1em; margin-top:-10px"></span></a></li>
                <li title="Refference"><a href="./Refference"><span class="fa fa-list" style="font-size:1em; margin-top:-10px"></span></a></li>
               </ul>
            </div>
