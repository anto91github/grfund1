...
<div style="background-color:#f7f7f7; padding-top:40px;">
  <div class="container">
    ...
    <div class="row">
      ...
      @endforeach
      <div class="col-md-12">            
            <span style="text-align:center"><h1><a class="btn btn-primary" href="./projectStartUp" style="font-size:18px;color:#696969;border-radius:5px !important;background-color:#F7F7F7">{{ Lang::get('core.home_see_more') }}</a></h1></span>
        </div>
    </div>
