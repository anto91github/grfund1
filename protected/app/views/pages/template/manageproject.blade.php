...
<div class="container" >
    <div class="col-md-8" id="containerInput">
        ...
        <div class="tab-content" style="padding-left:0px; padding-right:0px;">
            ...
            <div class='tab-pane {{ $tab == 4 ? "active" : "" }} fade in' id="tabUpdate">
                ...
                @if(count((array)$recent_updates) > 0)
                    ...
                    <div class="row" id="update{{$update->post_id}}">
                        <div style="font-size:24px">{{$update->post_date}}</div>
                        <div style="font-size:20px;padding-bottom:10px"><a href="../ShowUpdates?id={{$update->post_id}}&pid={{$update->project_id}}">{{$update->post_header}}</a></div>
                        <div style="font-size:16px">{{$update->small_content}}</div>
                        <button type="button" class="btn btn-primary editUpdate" data-id='{{$update->post_id}}'>Edit</button>
                        <button type="button" class="btn btn-default remove-updates" data-id='{{ $update->post_id }}'>Remove</button>
                        <hr/>
                    </div>
                    @endforeach
                    ...
                    @endif
                    <hr/>
                    <div style="text-align:center;padding-bottom:10px;font-size:20px">Add New Updates</div>
                    {{ Form::open(array('url'=>'manage-project/addpost', 'files'=>true, 'id'=>'formPost' )) }}
                        <input type='hidden' id="projectId" name="projectId" value="{{ $project->project_id }}">
                        ...
                        <label class="col-md-3 control-label">Title (English):</label>
                            <div class='col-md-9' style="padding-bottom:10px">
                                <input type='text' class='form-control' value="" id='postHeader_en' name='postHeader_en' />
                            </div>
                        ...
                        <label class="col-md-3 control-label">Short Description (English) :</label>
                            <div class='col-md-9' style="padding-bottom:10px">
                                <input type='text' class='form-control' value="" id='small_content_en' name='small_content_en' />
                            </div>
                        ...
                        <label class="col-md-3 control-label">Content : (English)</label>    
                            <div class='col-md-9' style="padding-bottom:10px">
                                <textarea rows='2' id='content_post_en' name='content_post_en' class='form-control '></textarea> 
                            </div>
...
<script type='text/javascript'>
    ...
    $(window).load(function(){         
        ...
        $(".editUpdate" ).click(function() {
            //var post_id = '{{SiteHelpers::encryptID($project->project_id)}}';
            var postId = $(this).data('id');                     
            var win = window.open('../EditUpdate?pid='+postId+'',"_self");
        });
