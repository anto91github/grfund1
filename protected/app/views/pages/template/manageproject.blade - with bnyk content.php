                    ...
                    <div class="form-horizontal" style="margin-top:20px; padding:0px 10px 0px 10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-xs-12 col-md-12'>
                                ...
                                <div class="col-xs-12 col-md-12" id="youtube_share"><h5 style="font-family: 'Helvetica'; font-weight:700;"><hr>Youtube Video URL:</h5><p>Share your Youtube Embeded Video <a href="#youtube_share" style="color:blue;" id="trigger6">&nbsp;(How to share Youtube Video)</a></p>                                                       
