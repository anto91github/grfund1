<style>
      ...
      .our-clients
      {
		...
		<div style="height:305px;margin-top:80px">
			<a href="/">
				<div class="col-xs-6 charity-btn" style="text-align:center;padding-top:100px;font-size:40px"></div>
				<!--<img src="video/home-vid/charity.png" height="55%">-->
			</a>

			<a href="UnderConstruction">
				<div class="col-xs-6 business-btn" style="text-align:center;padding-top:100px;font-size:40px">
		...
		<div class="" style="text-align:center; padding-bottom:0px">
			<div style="text-align:center;margin-bottom:50px;color:white;font-size:35px;font-family:verdana">
				<b>OR</b>
			</div>
        ...
        <div class="owl-carousel owl-carousel6-brands">
          ...
          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/binus.png" class="img-responsive" height="111" onmouseover="hover_binus(this);" onmouseout="unhover_binus(this);">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/tahir.png" height="130" onmouseover="hover_tahir(this);" onmouseout="unhover_tahir(this);">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/tzuchi.png" height="130" onmouseover="hover_tzuchi(this);" onmouseout="unhover_tzuchi(this);">
              </a>            
          </div>

          <div class="client-item" style="padding-top:10px">
              <a href="" target="_blank">
                  <img src="video/home-vid/cerdas-madani.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/sadarhati.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/besipae.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/arta-graha.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/komnas-pa.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/kop-slaras.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/ipasar.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>

          <div class="client-item">
              <a href="" target="_blank">
                  <img src="video/home-vid/kaffeine.png" class="img-responsive" height="130" onmouseover="" onmouseout="">
              </a>            
          </div>
...
function hover_binus(element) {
    element.setAttribute('src', 'video/home-vid/binus-hover.png');
}
function unhover_binus(element) {
    element.setAttribute('src', 'video/home-vid/binus.png');
}

function hover_tahir(element) {
    element.setAttribute('src', 'video/home-vid/tahir-hover.png');
}
function unhover_tahir(element) {
    element.setAttribute('src', 'video/home-vid/tahir.png');
}

function hover_tzuchi(element) {
    element.setAttribute('src', 'video/home-vid/tzuchi-hover.png');
}
function unhover_tzuchi(element) {
    element.setAttribute('src', 'video/home-vid/tzuchi.png');
}
