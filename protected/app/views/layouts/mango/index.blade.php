...
<?php 
$og_img= Session::get('og_img');
$og_title= Session::get('og_title');
$og_desc= Session::get('og_desc');
$og_url= Session::get('og_url');

if($og_img == NULL)
{
    $og_img = "logo-3.jpg";
    $og_url = "http://www.gotongroyong.fund";
    $og_title = "GotongroyongFund";
    $og_desc = "Indonesia's Leading Crowdfunding Platform";
}

echo "<meta property=\"og:title\" content=\"$og_title\"/>\n";
echo "<meta property=\"og:image\" content=\"http://www.gotongroyong.fund/uploads/banner/$og_img\"/>\n";
...
<link href='http://fonts.googleapis.com/css?family=Pathway+Gothic+One' rel='stylesheet' type='text/css'>
        ...
        {{ HTML::style('sximo/js/plugins/slider-revolution-slider/rs-plugin/css/settings.css') }}                       
        {{ HTML::style('sximo/js/style-revolution-slider.css') }}

        {{--HTML::style('css/circularnavigation/css/normalize.css')--}}
        {{--HTML::style('css/circularnavigation/css/demo.css')--}}
        {{--HTML::style('css/circularnavigation/css/component2.css')--}}
...
{{ HTML::script('sximo/js/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.plugins.min.js') }}
{{ HTML::script('sximo/js/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js') }}
{{ HTML::script('sximo/js/revo-slider.js') }}

{{--HTML::script('css/circularnavigation/js/modernizr-2.6.2.min.js')--}}

{{ HTML::script('css/fancybox/fancybox/jquery.fancybox-1.3.4.pack.js') }}
{{ HTML::style('css/fancybox/fancybox/jquery.fancybox-1.3.4.css') }}
{{ HTML::script('css/fancybox/fancybox/video.js') }}
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 left">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+6221 - 3190 9100</span></li>
...
<div class="sitemap" style="background-color: #89969f;">
	<div class=" container" >
            <!--
		<div class="col-sm-4 col-md-2 sitemap-container" >
            ...
            -->
            <div class="col-md-6 sitemap-container">
                <div style="margin-bottom:10px;margin-left:0px"><div href='about-us' style="color:#e54a1a;">
                        <h2 style="font-size:20px;">Sitemap</h2></div>                       
                    <ul style="font-size:18px">
                        <li>&nbsp;<a href="./faq" style="text-decoration:none;color:white">FAQ</a></li>
                        <li>&nbsp;<a href="./Testimoni" style="text-decoration:none;color:white">Testimonial</a></li>
                        <li>&nbsp;<a href="#" style="text-decoration:none;color:white">Payment</a></li>
                        <li>&nbsp;<a href="./terms-conditions" style="text-decoration:none;color:white">Term and Conditions</a></li>
                        <li>&nbsp;<a href="./contact-us" style="text-decoration:none;color:white">Contact Us</a></li>
                    </ul>
                </div> 
                <div>
                   <h2 class="color-orange" style="font-size:20px; margin-right:10px;padding-top:20px">Payment</h2>
                    <div style="padding-bottom:0px">{{ HTML::image('images/bank-logo.png','bank-logo',array('width'=>'100%','height'=>'40px'))}}</div>
                </div>               
            </div>
        <div class="col-md-1 sitemap-container">
            &nbsp;
        </div>    
		<div class="col-md-5 sitemap-container">
                <div class="col-md-12 pre-footer-subscribe-box pre-footer-subscribe-box-vertical" style="padding-left:0px; padding-right:0px;">
                   ...
                   <!-- Begin MailChimp Signup Form -->
                    ...
                    <style type="text/css">
                         #mc_embed_signup{background:#89969f; clear:left; font:14px Helvetica,Arial,sans-serif; }
                        /* Add your own MailChimp form style overrides in your site stylesheet or in this style block.
                           We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
                    </style>
                    <div id="mc_embed_signup" style="padding-right:100px;">
                        ...
                        <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" style="width:300px;" placeholder="yourmail@mail.com" required>
...
<!--End mc_embed_signup-->                    
                    ...
                    <div class="col-md-12" style="padding-left:0px;padding-right:0px;margin-top:40px;">
                        <h2 class="color-orange" style="font-size:20px; margin-right:10px;">Connect with us</h2>
                         <a href="https://www.facebook.com/gotongroyongfund" class="sitemap">{{ HTML::image("img/icons/fb-icon.png", "fb", array( 'height' => 24 )) }} <span class="hidden-xs">Facebook</span></a>&nbsp;
                         <a href="http://twitter.com/GRFund" class="sitemap">{{ HTML::image("img/icons/tweeter-icon.png", "twitter", array( 'height' => 24 )) }} <span class="hidden-xs">Twitter</span></a>&nbsp;
                         <a href="https://plus.google.com/113225882217101783794" class="sitemap">{{ HTML::image("img/icons/Google-plus-icon.png", "google+", array( 'height' => 24 )) }} <span class="hidden-xs">Google+</span></a>
                         <a href="https://www.youtube.com/channel/UCtjiTvU4D8cSSZYnQBGZlhA" class="sitemap">{{ HTML::image("img/icons/youtube-icon2.png", "youtube", array( 'height' => 24 )) }} <span class="hidden-xs">Youtube</span></a>&nbsp;
                         <a href="https://www.instagram.com/gotongroyongfund/" class="sitemap">{{ HTML::image("img/icons/ig_ico.png", "instagram", array( 'height' => 24 )) }} <span class="hidden-xs">Instagram</span></a>&nbsp;
                         <a href="https://www.linkedin.com/company/gotong-royong-fund" class="sitemap lk-footer">{{ HTML::image("img/icons/lk-icon.png", "lk", array( 'height' => 24 )) }} <span class="hidden-xs">Linkedin</span></a>&nbsp;
                    </div>
                </div>
...
<div id="footer">
	<div class=" container">
		<div class="col-md-9"> Copyright 2015 {{ CNF_APPNAME }} . ALL Rights Reserved. Supported by <a href="http://cerdasmadani.org/">Yayasan Pendidikan Cerdas Madani Indonesia</a> <a href="privacy-policy">Privacy Policy</a> | <a href="terms-conditions">Terms</a></div>
