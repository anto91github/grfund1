...
<!--End mc_embed_signup-->
                    <div class="col-md-12" style="padding-left:0px;padding-right:0px;margin-top:10px;">
                        <h2 class="color-orange" style="font-size:20px; margin-right:10px;">Connect with us</h2>
                         ...
                         <a href="https://plus.google.com/108338590412015686244" class="sitemap">{{ HTML::image("img/icons/Google-plus-icon.png", "vimeo", array( 'height' => 24 )) }} <span class="hidden-xs">Google+</span></a>
