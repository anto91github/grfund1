...
<link rel="shortcut icon" href="{{ URL::to('')}}/logo.ico" type="image/x-icon">
		...
		{{ HTML::style('sximo/js/plugins/bootstrap/css/font-awesome.css') }}
		{{ HTML::style('sximo/js/plugins/bootstrap/css/docs.css') }}
		{{ HTML::style('sximo/js/plugins/bootstrap/css/bootstrap-social.css') }}
