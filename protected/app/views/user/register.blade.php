<div class="sbox">
 ...
 {{ Form::open(array('url'=>'user/create', 'class'=>'form-signup')) }}
	...
	{{ Form::text('website', null, array('class'=>'form-control', 'placeholder'=>'Website URL')) }}
	...
	<div class="form-group has-feedback">
 	...
 	@endif						
	  ...
	  <a href="{{ URL::to('user/login')}}"> {{ Lang::get('core.back_login'); }} </a> | <a href="{{ URL::to('')}}">{{ Lang::get('core.back_site'); }}  </a> 
   		</p>
 {{ Form::close() }}
 </div>
</div> 
