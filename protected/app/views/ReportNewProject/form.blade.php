  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('ReportNewProject?md='.$filtermd) }}">{{ $pageTitle }}</a></li>
	...
	<div class="panel-default panel">
		...
		<ul class="parsley-error-list">
		 ...
		 {{ Form::open(array('url'=>'ReportNewProject/save/'.SiteHelpers::encryptID($row['rep_id']).'?md='.$filtermd.$trackUri, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
				<div class="col-md-12">
						<fieldset><legend> New Project per Month </legend>
									
								  <div class="form-group  " >
									<label for="Rep Id" class=" control-label col-md-4 text-left"> Rep Id </label>
									<div class="col-md-6">
									  {{ Form::text('rep_id', $row['rep_id'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('ReportNewProject?md='.$masterdetail["filtermd"].$trackUri) }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  
