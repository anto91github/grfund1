...
Route::get('/', 'HomeVideoController@showvideo');
...
Route::get('startup', 'StartUpController@showStartUp');
Route::get('projectStartUp', 'projectStartUpController@showProject');

Route::get('showHome/{label}', 'homeLabelController@showHome');
Route::get('LabelProjects/{label}', 'homeLabelController@showProject');
