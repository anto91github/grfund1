...
(function() {
 ...
 //////////////////////////////////////////////////////
/*var myContent7 = document.getElementById('content7');

 var myModal7 = new Modal({
     content: myContent7
 });

 var triggerButton7 = document.getElementById('trigger-comment')

 triggerButton7.addEventListener('click', function() {    
     myModal7.open();
 });*/
//----------------------------------------
var backerNum = document.getElementById('backerNum').value;
var myContent = [];
var myModal = [];
var triggerButton = [];
var send = [];
...
for (; i <= backerNum; i++) {
    myContent[i] = document.getElementById('content'+i);
    myModal[i] = new Modal({
        content: myContent[i]
    });
    triggerButton[i]= document.getElementById('trigger-comment'+i);
    send[i]=show_modal(i);
}
for (var j = 0; j <= backerNum; j++) {
    send[j]();

}*/


/*for (var i = 0; i < backerNum; i++) {
    myContent[i] = document.getElementById('content'+i);
    myModal[i] = new Modal({
            content: myContent[i]
    });   
...
var i = 0; 
 $(".trigger-comment").each(function(){   
   myContent[i] = document.getElementById('content'+i);
   myModal[i] = new Modal({
            content: myContent[i]
    });

         $("#trigger-comment"+i).click({param1: i}, showComment);           
   i++;
});
 function showComment(event) {
  //alert(event.data.param1);
  myModal[event.data.param1].open();
}
